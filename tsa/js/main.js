...
section02TL
  ...
  .from(".section02 .mainTxt01", { x: 100, opacity: 0, stagger: { each: 0.05 } })
...
section04TL
  ...
  .from(".section04 .list li", { scale: 0, opacity: 0, stagger: { each: 0.05 } });
...
section05TL
  ...
  .from(".section05 .list li", { scale: 0, opacity: 0, stagger: { each: 0.05 } });
...
section06TL
  ...
  .from(".section06 .btns a", { scale: 0, opacity: 0, stagger: { each: 0.05 } });
